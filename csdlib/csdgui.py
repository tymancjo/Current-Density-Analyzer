...
class currentDensityWindow:
    ...
    def __init__(self, master, XsecArr, dXmm, dYmm):
        ...
        self.desc_I = tk.Label(self.bframe, text="Current: {:.2f} [A]".format(self.I))
        self.desc_I.pack()
    ...
    def calcTempRise(self):
        ...
        if self.isSolved:
            ...
            for i, bar in enumerate(self.bars):
                ...
                print(
                    "Bar {0:02d}; Power; {1:06.2f}; [W]; perymeter; {2} [mm]; Current; {3:.1f}; [A]".format(
